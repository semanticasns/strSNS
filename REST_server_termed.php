...
// REST Términos medicamentos
	...
	$fichero = $_SESSION['id_suscrip']."_termed_".$aleat."_".$fecha.".json" ;
	$fice = $_SESSION['id_suscrip']."_termed_".$aleat."_".$fecha.".json" ;		
	$sql = $dbConn->prepare("select id, conceptId, term, typeId, languageCode from snomedct_drug.sct2_description_spaindrugsnapshot_es_es 
								where term like ? and active = 1 order by term ");
