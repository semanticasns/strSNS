<?php
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = $dbConn->prepare("SELECT id_suscrip, organizacion, contacto_mail, server_ftp, server_ftp_folder FROM str_suscriptores WHERE login = ? and password = ? ");
		...
		if($result == 1) {			
			while ($fila = $sql->fetch(PDO::FETCH_ASSOC)) {  	
				...
				header("location: strSNS_peticion.php");
			}
		}			
...
<html>  
	...
	<body bgcolor = "#FFFFFF">	
		<table>
		<tr><td><img alt='Ministerio de Sanidad' width='265px' src='MSAGob.jpg'></td><td class='titular'><b>strSNS</b><br>Servidor de Terminologías de Referencia del SNS</td></tr>
		</table>
		<div align = "center"><br><br><br><br>
			<div style = "width:400px; border: solid 1px #333333; " align = "left">
				...
				<div style = "margin:30px">              
					...
					<table>
						<tr><td><a href=''>Solicitar alta como suscriptor</a></td></tr>
					</table>
