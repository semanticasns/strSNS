...
// REST Términos medicamentos
	...
	$fichero = $_SESSION['id_suscrip']."_termosc_".$aleat."_".$fecha.".json" ;
	$fice = $_SESSION['id_suscrip']."_termosc_".$aleat."_".$fecha.".json" ;		
	$sql = $dbConn->prepare("select * from snomedct_drug.clinical_safety_ontology ") ;
	$sql->execute();
	$result = $sql->rowCount();	
	if ($result == 0)  { 
