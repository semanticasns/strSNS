...
// REST Valueset Formas Farmacéuticas Alcántara
	...
	$sql = $dbConn->prepare("select * from recursos.mtc_local_cie9mc_dx_2014 where (descriptor_es like '%".$filtro."%' or descriptor_es like '".$filtro."%' or descriptor_en like '%".$filtro."%' or descriptor_en like '".$filtro."%' or code like '".$busca."%' or code like '%".$busca."%') and active = 1 ");
...
//	$sql->bindValue(1, "$filtro", PDO::PARAM_INT);
	...
	echo "<h2>CIE-9-MC DIAGNÓSTICOS 2014</h2>" ;
	echo "<table>" ;
