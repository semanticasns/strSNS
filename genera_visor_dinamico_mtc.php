...
$sql01 = "select nemotec, MTC_tabla, bd, tabla, grupo, fecha_ultima_actualiz from strsns.str_recursos where nemotec = '".$busca."' " ;
...
while ($rg1 = mysqli_fetch_array($res01)) :	
	...
	$va04 = $rg1['tabla'] ;  
	$va05 = $rg1['grupo'] ;  
	$va06 = $rg1['fecha_ultima_actualiz'] ;	
endwhile ;
...
$vis01A = $vis01A ."".  "<big><big><big>Visor web de MTC (Master Translation Catalog): ".$va02." </big></big></big><br/> " ."\r\n" ;
$vis01A = $vis01A ."".  "<hr/> " ."\r\n" ;
...
$vis01C = $vis01C ."".  "<ul> " ."\r\n" ;
$vis01C = $vis01C ."".  "<li>El  de ".$va02." se presenta como una tabla con buscadores para cada columna.</li> " ."\r\n";
$vis01C = $vis01C ."".  "<li>Cada fila contiene un elemento del MTC de ".$va02.".</li> " ."\r\n";
$vis01C = $vis01C ."".  "</ul></li> " ."\r\n" ;

$vis01C = $vis01C ."".  "<li><strong>Tabla de Contenidos:</strong> " ."\r\n" ;
$vis01C = $vis01C ."".  "<ul><li>La Tabla de Contenidos puede filtrar el contenido de la lista pulsando sobre los botones de las cabeceras de columna, " ."\r\n" ;
$vis01C = $vis01C ."".  "introduciendo la cadena que quiera buscar.</li> " ."\r\n" ;
$vis01C = $vis01C ."".  "<li>La columna Master Translate Catalog (MTC) muestra los códigos SNOMED CT de los conceptos relacionados, y actúa como enlace a la página MultilingualTree, donde se muestra toda la información relacionada con el concepto.</li>" ."\r\n" ;
$vis01C = $vis01C ."".  "<li>La columna CodeSystem contiene el Id del sistema de codificación adoptado para este MTC" ."\r\n" ;
$vis01C = $vis01C ."".  "<li>La columna CodeVersion contiene la versión del MTC" ."\r\n" ;
$vis01C = $vis01C ."".  "<li>La columna CodeConcept contiene el Id del miembro del MTC" ."\r\n" ;
$vis01C = $vis01C ."".  "<li>La columna description_en contiene la descripción en inglés (original)" ."\r\n" ;
$vis01C = $vis01C ."".  "<li>La columna description_es contiene la descripción en español (traducida)" ."\r\n" ;
...
$vis03A = $vis03A ."".  "<th width='10%'><input type='button' title='' value='CodeSystem' onclick='selecciona(this,0)' onkeypress='selecciona(this,0)' /></th> " ."\r\n" ;
$vis03A = $vis03A ."".  "<th width='5%'><input type='button' title='' value='CodeVersion' onclick='selecciona(this,1)' onkeypress='selecciona(this,1)' /></th> " ."\r\n" ;
$vis03A = $vis03A ."".  "<th width='12%'><input type='button' title='' value='CodeConcept' onclick='selecciona(this,2)' onkeypress='selecciona(this,2)' /></th> " ."\r\n" ;
$vis03A = $vis03A ."".  "<th width='35%'><input type='button' title='' value='description_en' onclick='selecciona(this,3)' onkeypress='selecciona(this,3)' /></th> " ."\r\n" ;
$vis03A = $vis03A ."".  "<th width='35%'><input type='button' title='' value='description_es' onclick='selecciona(this,4)' onkeypress='selecciona(this,4)' /></th> " ."\r\n" ;
$vis03A = $vis03A ."".  "<th width='4%'><input type='button' title='' value='Mail' onclick='selecciona(this,5)' onkeypress='selecciona(this,5)' /></th> " ."\r\n" ;
$vis03A = $vis03A ."".  "</tr> " ."\r\n" ;
...
$sql00 = "select CodeSystem, CodeVersion, CodeConcept, description_en, description_es from ".$va03.".".$va04." order by description_es " ;
$res00 = mysqli_query($conn,$sql00) or die ("Error: " . mysqli_error()); 
	...
	while ($row = mysqli_fetch_array($res00)): 
		$line ++ ;	
		$cmp1 = $row['CodeSystem'] ;
		$cmp2 = $row['CodeVersion'] ;		
		$cmp3 = $row['CodeConcept'] ;	
		$cmp4 = $row['description_en'] ;				
		$cmp5 = $row['description_es'] ;			
		$cmp6 = "<a href='mailto:semanticasns@mscbs.es?subject=Comentario sobre MTC ".$va02."&body=Concepto: ".$cmp3." |".$cmp5."|  %0A%0AComentarios: %0A%0A' >e-mail</a>" ;
		$fila2 = "<tr><td>".$cmp1."</td><td>".$cmp2."</td><td>".$cmp3."</td><td>".$cmp4."</td><td>".$cmp5."</td><td>".$cmp6."</td></tr>"."\r\n" ;	
		$vis04 = $vis04 ."". $fila2 ;	
	endwhile ; 
