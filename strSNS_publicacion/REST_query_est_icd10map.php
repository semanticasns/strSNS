...
// REST Mapeo SNOMED CT a ICD-10 WHO
	...
	$sql = $dbConn->prepare("select * from der2_iisssccrefset_extendedmapsnapshot_int a inner join sct2_description_snapshot_global b
...
//	$sql->bindValue(1, "$filtro", PDO::PARAM_INT);
	...
	echo "<h2>ICD-10 WHO Map to SNOMED CT</h2>" ;
	echo "<table>" ;
