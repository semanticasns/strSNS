...
// REST Valueset Formas Farmacéuticas Alcántara
	...
	$sql = $dbConn->prepare("select * from recursos.mtc_local_cie10es_2020 where (descriptor_es like '%".$filtro."%' or descriptor_es like '".$filtro."%' or descriptor_en like '%".$filtro."%' or descriptor_en like '".$filtro."%' or code like '".$busca."%' or code like '%".$busca."%') and active = 1 ");
